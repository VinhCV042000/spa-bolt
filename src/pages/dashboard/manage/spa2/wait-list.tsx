...
export default function Page() {
  ...
  const base = SPA2_MANAGE_CONFIGS['wait-list'];
  const config = {
    ...base,
    title: t('wait_list.page_title') || base.title,
    addLabel: t('wait_list.add_btn') || base.addLabel,
    breadcrumbLabel: t('wait_list.breadcrumb') || base.breadcrumbLabel,
  };
  return (
    <>
      <Helmet>
