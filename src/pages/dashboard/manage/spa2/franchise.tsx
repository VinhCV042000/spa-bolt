...
export default function Page() {
  ...
  const base = SPA2_MANAGE_CONFIGS.franchise;
  const config = {
    ...base,
    title: t('franchise.page_title') || base.title,
    addLabel: t('franchise.add_btn') || base.addLabel,
    breadcrumbLabel: t('franchise.breadcrumb') || base.breadcrumbLabel,
  };
  return (
    <>
      <Helmet>
