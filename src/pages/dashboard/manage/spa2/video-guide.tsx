...
export default function Page() {
  ...
  const base = SPA2_MANAGE_CONFIGS['video-guide'];
  const config = {
    ...base,
    title: t('video_guide.page_title') || base.title,
    addLabel: t('video_guide.add_btn') || base.addLabel,
    breadcrumbLabel: t('video_guide.breadcrumb') || base.breadcrumbLabel,
  };
  return (
    <>
      <Helmet>
