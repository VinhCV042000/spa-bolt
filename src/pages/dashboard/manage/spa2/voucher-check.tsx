...
export default function Page() {
  ...
  const base = SPA2_MANAGE_CONFIGS['voucher-check'];
  const config = {
    ...base,
    title: t('voucher_check.page_title') || base.title,
    addLabel: t('voucher_check.add_btn') || base.addLabel,
    breadcrumbLabel: t('voucher_check.breadcrumb') || base.breadcrumbLabel,
  };
  return (
    <>
      <Helmet>
