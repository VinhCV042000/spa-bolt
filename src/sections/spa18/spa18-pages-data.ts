// ----------------------------------------------------------------------
// spa18 sub-pages – Jungle Haven theme (Balinese tropical jungle spa)
// Terracotta, saffron gold, night indigo & sand — Bali tropical jungle palette.
// ----------------------------------------------------------------------

export const SPA18_TERRA = '#D4A574';
export const SPA18_TERRA_DARK = '#8B6F47';
export const SPA18_TERRA_LIGHT = '#E8C89A';
export const SPA18_SAND = '#FDF6E3';
export const SPA18_SAND_DARK = '#D4C79A';
export const SPA18_OLIVE = '#52B788';
export const SPA18_WARM = '#FAF3D8';
export const SPA18_INK = '#1B4332';
export const SPA18_TERRA_SOFT = '#F4E4C1';

export const SPA18_PAGE_IMAGES = {
...
// Thêm field "category" cho spa18Services (chèn vào từng object hiện có), ví dụ:
...
export const spa18ServiceCategories = [
...
export const spa18ServiceSteps = [
  {
...
export const spa18PartnerProfiles = [
  {
    name: 'Comfort Zone',
    country: 'Italy',
    logo: 'CZ',
...
export const spa18VideoReviews = [
  {
    name: 'Minh Anh',
...
export const spa18BlogCategories = [
...
export const spa18Branches = [
  {
    city: 'TP. Hồ Chí Minh',
    name: 'Jungle Haven Quận 1',
...
export const spa18TrainingPrograms = [
  {
...
export const spa18AboutStory: string[] = [
...
export const spa18VisionMission = [
  {
...
export const spa18Certifications = [
  {
...
export const spa18Feedbacks = [
  ...
  },
  {
    ...
    comment: 'Gói đôi rất lãng mạn, vợ mình rất thích. Cảm ơn Jungle Haven!',
    service: 'Spa đôi',
  },
];

export const spa18BeforeAfters = [
  {
...
export const spa18Faqs = [
  ...
  },
  {
    ...
    a: 'Có. Jungle Haven hỗ trợ trả góp 0% qua thẻ tín dụng của 12 ngân hàng đối tác.',
  },
  {
...
// ---- Booking ----
export const spa18BookingPackages = [
  {
    slug: 'goi-co-ban',
    name: 'Gói Cơ Bản',
    price: 690000,
...
// ---- Careers detail ----
export const spa18CareersSlogan = 'Nơi đam mê làm đẹp gặp gỡ cơ hội phát triển';

export const spa18JoinReasons = [
...
export const spa18RecruitmentProcess = [
  ...
  { step: 'Nhận việc', desc: 'Chính thức gia nhập đội ngũ Jungle Haven.' },
];

export const spa18WorkplaceGallery = [
...
export const spa18GraduateShowcase = [
  {
    name: 'Lớp KTV K12',
...
// ---- Partners (extended) ----
export const spa18PartnerCategories = [
...
// Thêm field category vào spa18PartnerProfiles (mục trước):
...
export const spa18ExtraPartners = [
  {
    name: 'Lumiere Tech',
    country: 'Germany',
    logo: 'LT',
...
export const spa18Collaborations = [
  {
...
export const spa18QualityCerts = [
  {
    name: 'FDA',
...
// ---- Treatments process ----
export const spa18TreatmentProcess = [
...
// ---- Before/After tech ----
export const spa18Technologies = [
  {
    name: 'Máy RF đa cực',
...
export const spa18TreatmentExperts = [
  {
    name: 'Trần Minh Khôi',
