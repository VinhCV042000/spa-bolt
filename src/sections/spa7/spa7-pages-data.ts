// ----------------------------------------------------------------------
// spa7 sub-pages – Noir & Rose theme (rose gold / blush / cream)
// Distinct from spa2 (teal nature) – editorial noir with rose gold, glossy dark accents.
// ----------------------------------------------------------------------

export const SPA7_TERRA = '#B76E79';
export const SPA7_TERRA_DARK = '#8B4A55';
export const SPA7_TERRA_LIGHT = '#D48A96';
export const SPA7_SAND = '#F8F1EC';
export const SPA7_SAND_DARK = '#EBDDD3';
export const SPA7_OLIVE = '#C9A66B';
export const SPA7_WARM = '#FBEEE8';
export const SPA7_INK = '#1A0F14';
export const SPA7_TERRA_SOFT = '#F5D9DC';

export const SPA7_PAGE_IMAGES = {
...
// Thêm field "category" cho spa7Services (chèn vào từng object hiện có), ví dụ:
...
export const spa7ServiceCategories = [
...
export const spa7PartnerProfiles = [
  {
    name: 'Comfort Zone',
    country: 'Italy',
    logo: 'CZ',
...
export const spa7BlogCategories = [
...
export const spa7Branches = [
  {
    city: 'TP. Hồ Chí Minh',
    name: 'Noir & Rose Quận 1',
...
export const spa7TrainingPrograms = [
  {
...
export const spa7AboutStory: string[] = [
...
export const spa7VisionMission = [
  {
...
export const spa7Certifications = [
  {
...
export const spa7Feedbacks = [
  ...
  },
  {
    ...
    comment: 'Gói đôi rất lãng mạn, vợ mình rất thích. Cảm ơn Noir & Rose!',
    service: 'Spa đôi',
  },
];

export const spa7BeforeAfters = [
  {
...
export const spa7Faqs = [
  ...
  },
  {
    ...
    a: 'Có. Noir & Rose hỗ trợ trả góp 0% qua thẻ tín dụng của 12 ngân hàng đối tác.',
  },
  {
...
export const spa7ContactInfo = {
  hotline: '1900 6789',
  email: 'hello@noirandrose.vn',
  zalo: '0909 868 868',
  address: '45 Nguyễn Huệ, Quận 1, TP.HCM',
...
// ---- Booking ----
export const spa7BookingPackages = [
  {
    slug: 'goi-co-ban',
    name: 'Gói Cơ Bản',
    price: 690000,
...
// ---- Careers detail ----
export const spa7CareersSlogan = 'Nơi đam mê làm đẹp gặp gỡ cơ hội phát triển';

export const spa7JoinReasons = [
...
export const spa7RecruitmentProcess = [
  ...
  { step: 'Nhận việc', desc: 'Chính thức gia nhập đội ngũ Noir & Rose.' },
];

export const spa7WorkplaceGallery = [
...
export const spa7GraduateShowcase = [
  {
    name: 'Lớp KTV K12',
...
// ---- Partners (extended) ----
export const spa7PartnerCategories = [
...
// Thêm field category vào spa7PartnerProfiles (mục trước):
...
export const spa7ExtraPartners = [
  {
    name: 'Lumiere Tech',
    country: 'Germany',
    logo: 'LT',
...
export const spa7Collaborations = [
  {
...
// ---- Treatments process ----
export const spa7TreatmentProcess = [
...
export const spa7TreatmentExperts = [
  {
    name: 'Trần Minh Khôi',
