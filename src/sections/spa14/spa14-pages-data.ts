// ----------------------------------------------------------------------
// spa14 sub-pages – Imperial Vienna theme (burgundy / gold / cream)
// Belle Époque Austro-Hungarian palette: deep wine burgundy with imperial gold accents on cream.
// ----------------------------------------------------------------------

export const SPA14_TERRA = '#8B1A2F';
export const SPA14_TERRA_DARK = '#5A0E1E';
export const SPA14_TERRA_LIGHT = '#B03448';
export const SPA14_SAND = '#FAF0E6';
export const SPA14_SAND_DARK = '#E8D4B0';
export const SPA14_OLIVE = '#C9A55A';
export const SPA14_WARM = '#F5E6D3';
export const SPA14_INK = '#1A0A12';
export const SPA14_TERRA_SOFT = '#F2D5DB';

export const SPA14_PAGE_IMAGES = {
...
// Thêm field "category" cho spa14Services (chèn vào từng object hiện có), ví dụ:
...
export const spa14ServiceCategories = [
...
export const spa14ServiceSteps = [
  {
...
export const spa14PartnerProfiles = [
  {
    name: 'Comfort Zone',
    country: 'Italy',
    logo: 'CZ',
...
export const spa14VideoReviews = [
  {
    name: 'Minh Anh',
...
export const spa14BlogCategories = [
...
export const spa14Branches = [
  {
    city: 'TP. Hồ Chí Minh',
    name: 'Imperial Vienna Quận 1',
  ...
  {
    city: 'Đà Nẵng',
    name: 'Imperial Vienna Biển Mỹ Khê',
  ...
  {
    city: 'Nha Trang',
    name: 'Imperial Vienna Nha Trang',
...
export const spa14TrainingPrograms = [
  {
...
export const spa14AboutStory: string[] = [
...
export const spa14VisionMission = [
  {
...
export const spa14Certifications = [
  {
...
export const spa14Feedbacks = [
  ...
  },
  {
    ...
    comment: 'Gói đôi rất lãng mạn, vợ mình rất thích. Cảm ơn Imperial Vienna!',
    service: 'Spa đôi',
  },
];

export const spa14BeforeAfters = [
  {
...
export const spa14Faqs = [
  ...
  },
  {
    ...
    a: 'Có. Imperial Vienna hỗ trợ trả góp 0% qua thẻ tín dụng của 12 ngân hàng đối tác.',
  },
  {
...
// ---- Booking ----
export const spa14BookingPackages = [
  {
    slug: 'goi-co-ban',
    name: 'Gói Cơ Bản',
    price: 690000,
...
// ---- Careers detail ----
export const spa14CareersSlogan = 'Nơi đam mê làm đẹp gặp gỡ cơ hội phát triển';

export const spa14JoinReasons = [
...
export const spa14RecruitmentProcess = [
  ...
  { step: 'Nhận việc', desc: 'Chính thức gia nhập đội ngũ Imperial Vienna.' },
];

export const spa14WorkplaceGallery = [
...
export const spa14GraduateShowcase = [
  {
    name: 'Lớp KTV K12',
...
// ---- Partners (extended) ----
export const spa14PartnerCategories = [
...
// Thêm field category vào spa14PartnerProfiles (mục trước):
...
export const spa14ExtraPartners = [
  {
    name: 'Lumiere Tech',
    country: 'Germany',
    logo: 'LT',
...
export const spa14Collaborations = [
  {
...
export const spa14QualityCerts = [
  {
    name: 'FDA',
...
// ---- Treatments process ----
export const spa14TreatmentProcess = [
...
// ---- Before/After tech ----
export const spa14Technologies = [
  {
    name: 'Máy RF đa cực',
...
export const spa14TreatmentExperts = [
  {
    name: 'Trần Minh Khôi',
