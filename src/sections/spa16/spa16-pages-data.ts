// ----------------------------------------------------------------------
// spa16 sub-pages – Riad Al-Andalus theme (Moroccan hammam)
// Terracotta, saffron gold, night indigo & sand — Marrakech riad palette.
// ----------------------------------------------------------------------

export const SPA16_TERRA = '#C25B3F';
export const SPA16_TERRA_DARK = '#8A4B2A';
export const SPA16_TERRA_LIGHT = '#D87A5E';
export const SPA16_SAND = '#F2E5D0';
export const SPA16_SAND_DARK = '#D8C79E';
export const SPA16_OLIVE = '#E0A458';
export const SPA16_WARM = '#F8EFDC';
export const SPA16_INK = '#0E1A2B';
export const SPA16_TERRA_SOFT = '#F5D9C7';

export const SPA16_PAGE_IMAGES = {
...
// Thêm field "category" cho spa16Services (chèn vào từng object hiện có), ví dụ:
...
export const spa16ServiceCategories = [
...
export const spa16ServiceSteps = [
  {
...
export const spa16PartnerProfiles = [
  {
    name: 'Comfort Zone',
    country: 'Italy',
    logo: 'CZ',
...
export const spa16VideoReviews = [
  {
    name: 'Minh Anh',
...
export const spa16BlogCategories = [
...
export const spa16Branches = [
  {
    city: 'TP. Hồ Chí Minh',
    name: 'Riad Al-Andalus Quận 1',
  ...
  {
    city: 'Đà Nẵng',
    name: 'Riad Al-Andalus Biển Mỹ Khê',
  ...
  {
    city: 'Nha Trang',
    name: 'Riad Al-Andalus Nha Trang',
...
export const spa16TrainingPrograms = [
  {
...
export const spa16AboutStory: string[] = [
...
export const spa16VisionMission = [
  {
...
export const spa16Certifications = [
  {
...
export const spa16Feedbacks = [
  ...
  },
  {
    ...
    comment: 'Gói đôi rất lãng mạn, vợ mình rất thích. Cảm ơn Riad Al-Andalus!',
    service: 'Spa đôi',
  },
];

export const spa16BeforeAfters = [
  {
...
export const spa16Faqs = [
  ...
  },
  {
    ...
    a: 'Có. Riad Al-Andalus hỗ trợ trả góp 0% qua thẻ tín dụng của 12 ngân hàng đối tác.',
  },
  {
...
// ---- Booking ----
export const spa16BookingPackages = [
  {
    slug: 'goi-co-ban',
    name: 'Gói Cơ Bản',
    price: 690000,
...
// ---- Careers detail ----
export const spa16CareersSlogan = 'Nơi đam mê làm đẹp gặp gỡ cơ hội phát triển';

export const spa16JoinReasons = [
...
export const spa16RecruitmentProcess = [
  ...
  { step: 'Nhận việc', desc: 'Chính thức gia nhập đội ngũ Riad Al-Andalus.' },
];

export const spa16WorkplaceGallery = [
...
export const spa16GraduateShowcase = [
  {
    name: 'Lớp KTV K12',
...
// ---- Partners (extended) ----
export const spa16PartnerCategories = [
...
// Thêm field category vào spa16PartnerProfiles (mục trước):
...
export const spa16ExtraPartners = [
  {
    name: 'Lumiere Tech',
    country: 'Germany',
    logo: 'LT',
...
export const spa16Collaborations = [
  {
...
export const spa16QualityCerts = [
  {
    name: 'FDA',
...
// ---- Treatments process ----
export const spa16TreatmentProcess = [
...
// ---- Before/After tech ----
export const spa16Technologies = [
  {
    name: 'Máy RF đa cực',
...
export const spa16TreatmentExperts = [
  {
    name: 'Trần Minh Khôi',
