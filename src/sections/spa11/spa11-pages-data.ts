// ----------------------------------------------------------------------
// spa11 sub-pages – Hammam Marrakech theme (rose gold / blush / cream)
// Distinct from spa2 (teal nature) – warm Moroccan terracotta with majorelle blue accents.
// ----------------------------------------------------------------------

export const SPA11_TERRA = '#B85C38';
export const SPA11_TERRA_DARK = '#7A3A22';
export const SPA11_TERRA_LIGHT = '#D98763';
export const SPA11_SAND = '#F5EBD9';
export const SPA11_SAND_DARK = '#E8D5B0';
export const SPA11_OLIVE = '#2E5266';
export const SPA11_WARM = '#FBF3E4';
export const SPA11_INK = '#2B1810';
export const SPA11_TERRA_SOFT = '#F5D9C2';

export const SPA11_PAGE_IMAGES = {
...
// Thêm field "category" cho spa11Services (chèn vào từng object hiện có), ví dụ:
...
export const spa11ServiceCategories = [
...
export const spa11ServiceSteps = [
  {
...
export const spa11PartnerProfiles = [
  {
    name: 'Comfort Zone',
    country: 'Italy',
    logo: 'CZ',
...
export const spa11VideoReviews = [
  {
    name: 'Minh Anh',
...
export const spa11BlogCategories = [
...
export const spa11Branches = [
  {
    city: 'TP. Hồ Chí Minh',
    name: 'Hammam Marrakech Quận 1',
  ...
  {
    city: 'Đà Nẵng',
    name: 'Hammam Marrakech Biển Mỹ Khê',
  ...
  {
    city: 'Nha Trang',
    name: 'Hammam Marrakech Nha Trang',
...
export const spa11TrainingPrograms = [
  {
...
export const spa11AboutStory: string[] = [
...
export const spa11VisionMission = [
  {
...
export const spa11Certifications = [
  {
...
export const spa11Feedbacks = [
  ...
  },
  {
    ...
    comment: 'Gói đôi rất lãng mạn, vợ mình rất thích. Cảm ơn Hammam Marrakech!',
    service: 'Spa đôi',
  },
];

export const spa11BeforeAfters = [
  {
...
export const spa11Faqs = [
  ...
  },
  {
    ...
    a: 'Có. Hammam Marrakech hỗ trợ trả góp 0% qua thẻ tín dụng của 12 ngân hàng đối tác.',
  },
  {
...
// ---- Booking ----
export const spa11BookingPackages = [
  {
    slug: 'goi-co-ban',
    name: 'Gói Cơ Bản',
    price: 690000,
...
// ---- Careers detail ----
export const spa11CareersSlogan = 'Nơi đam mê làm đẹp gặp gỡ cơ hội phát triển';

export const spa11JoinReasons = [
...
export const spa11RecruitmentProcess = [
  ...
  { step: 'Nhận việc', desc: 'Chính thức gia nhập đội ngũ Hammam Marrakech.' },
];

export const spa11WorkplaceGallery = [
...
export const spa11GraduateShowcase = [
  {
    name: 'Lớp KTV K12',
...
// ---- Partners (extended) ----
export const spa11PartnerCategories = [
...
// Thêm field category vào spa11PartnerProfiles (mục trước):
...
export const spa11ExtraPartners = [
  {
    name: 'Lumiere Tech',
    country: 'Germany',
    logo: 'LT',
...
export const spa11Collaborations = [
  {
...
export const spa11QualityCerts = [
  {
    name: 'FDA',
...
// ---- Treatments process ----
export const spa11TreatmentProcess = [
...
// ---- Before/After tech ----
export const spa11Technologies = [
  {
    name: 'Máy RF đa cực',
...
export const spa11TreatmentExperts = [
  {
    name: 'Trần Minh Khôi',
