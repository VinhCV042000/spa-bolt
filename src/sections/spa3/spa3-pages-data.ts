// ----------------------------------------------------------------------
// spa3 sub-pages – Mediterranean Warmth theme (terracotta / sand / olive)
// Distinct from spa2 (teal nature) – warm sunlit, arched shapes, editorial.
// ----------------------------------------------------------------------

export const SPA3_TERRA = '#C75B39';
export const SPA3_TERRA_DARK = '#9A3F24';
export const SPA3_TERRA_LIGHT = '#E07B5A';
export const SPA3_SAND = '#F5E6D3';
export const SPA3_SAND_DARK = '#E8D5BF';
export const SPA3_OLIVE = '#A8B37A';
export const SPA3_WARM = '#F2E4D0';
export const SPA3_INK = '#3B2317';
export const SPA3_TERRA_SOFT = '#F0B49B';

export const SPA3_PAGE_IMAGES = {
...
// Thêm field "category" cho spa3Services (chèn vào từng object hiện có), ví dụ:
...
export const spa3ServiceCategories = [
...
export const spa3PartnerProfiles = [
  {
    name: 'Comfort Zone',
    country: 'Italy',
    logo: 'CZ',
...
export const spa3BlogCategories = [
...
export const spa3Branches = [
  {
    city: 'TP. Hồ Chí Minh',
    name: 'Mediterranean Spa Quận 1',
  ...
  {
    city: 'Đà Nẵng',
    name: 'Mediterranean Spa Biển Mỹ Khê',
  ...
  {
    city: 'Nha Trang',
    name: 'Mediterranean Spa Nha Trang',
...
export const spa3TrainingPrograms = [
  {
...
export const spa3AboutStory: string[] = [
...
export const spa3VisionMission = [
  {
...
export const spa3Certifications = [
  {
...
export const spa3Feedbacks = [
  ...
  },
  {
    ...
    comment: 'Gói đôi rất lãng mạn, vợ mình rất thích. Cảm ơn Mediterranean Spa!',
    service: 'Spa đôi',
  },
];

export const spa3BeforeAfters = [
  {
...
export const spa3Faqs = [
  ...
  },
  {
    ...
    a: 'Có. Mediterranean Spa hỗ trợ trả góp 0% qua thẻ tín dụng của 12 ngân hàng đối tác.',
  },
  {
...
export const spa3ContactInfo = {
  hotline: '1900 6789',
  email: 'hello@mediterraneanspa.vn',
  zalo: '0909 868 868',
  address: '45 Nguyễn Huệ, Quận 1, TP.HCM',
...
// ---- Booking ----
export const spa3BookingPackages = [
  {
    slug: 'goi-co-ban',
    name: 'Gói Cơ Bản',
    price: 690000,
...
// ---- Careers detail ----
export const spa3CareersSlogan = 'Nơi đam mê làm đẹp gặp gỡ cơ hội phát triển';

export const spa3JoinReasons = [
...
export const spa3RecruitmentProcess = [
  ...
  { step: 'Nhận việc', desc: 'Chính thức gia nhập đội ngũ Mediterranean Spa.' },
];

export const spa3WorkplaceGallery = [
...
export const spa3GraduateShowcase = [
  {
    name: 'Lớp KTV K12',
...
// ---- Partners (extended) ----
export const spa3PartnerCategories = [
...
// Thêm field category vào spa3PartnerProfiles (mục trước):
...
export const spa3ExtraPartners = [
  {
    name: 'Lumiere Tech',
    country: 'Germany',
    logo: 'LT',
...
export const spa3Collaborations = [
  {
...
// ---- Treatments process ----
export const spa3TreatmentProcess = [
...
export const spa3TreatmentExperts = [
  {
    name: 'Trần Minh Khôi',
